...
<div class="w-[55%] bg-white flex items-center justify-center p-[60px]">
    <div class="w-full max-w-[420px]">
        <h2 class="font-playfair text-[2rem] text-[#1a1a1a] mb-1.5">Buat Akun Baru</h2>
        <p class="text-[#999] text-[0.9rem] mb-8">Isi data diri Anda untuk mulai berbelanja</p>
        ...
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div class="mb-[18px]">
                <label class="block font-bold text-[0.85rem] text-[#555] mb-2 tracking-[0.5px] uppercase">Nama Lengkap</label>
                <div class="relative">
                    <i class="fas fa-user absolute left-4 top-1/2 -translate-y-1/2 text-[#bbb] text-[0.9rem]"></i>
            ...
            <div class="mb-[18px]">
                <label class="block font-bold text-[0.85rem] text-[#555] mb-2 tracking-[0.5px] uppercase">Konfirmasi Password</label>
                <div class="relative">
                    <i class="fas fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-[#bbb] text-[0.9rem]"></i>
            ...
            <button type="submit"
                class="w-full mt-2 py-[15px] bg-maroon text-white border-none rounded-xl text-base font-bold font-sans cursor-pointer transition-all duration-200 flex items-center justify-center gap-[10px] hover:bg-maroon-dark hover:-translate-y-px hover:shadow-[0_6px_20px_rgba(139,26,26,0.3)]">
