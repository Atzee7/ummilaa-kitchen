...
<div class="hidden md:flex md:w-[45%] bg-[linear-gradient(160deg,#8B1A1A_0%,#4a0c0c_100%)] flex-col justify-between p-[50px] relative overflow-hidden">
    ...
    <div class="text-white relative z-[1]">
        ...
        <div class="mt-8 flex flex-col gap-[14px]">
            ...
            <div class="flex items-center gap-3 text-white text-[0.9rem]">
                <div class="w-9 h-9 bg-white/15 rounded-full flex items-center justify-center text-[0.85rem] flex-shrink-0"><i class="fas fa-history"></i></div>
...
<div class="w-full md:w-[55%] bg-white flex items-center justify-center px-6 py-10 sm:px-10 sm:py-12 md:p-[60px] min-h-screen">
    <div class="w-full max-w-[360px]">
        ...
        <h2 class="font-playfair text-[1.6rem] md:text-[2rem] text-[#1a1a1a] mb-1">Selamat Datang!</h2>
        <p class="text-[#aaa] text-[0.82rem] md:text-[0.9rem] mb-6 md:mb-9">Masuk dengan akun Ummilaa Kitchen Anda</p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex justify-between items-center mb-5 text-[0.82rem]">
                <label class="flex items-center gap-2 text-[#888] cursor-pointer">
                    <input type="checkbox" name="remember" class="accent-maroon w-3.5 h-3.5"> Ingat saya
                </label>
            </div>
            <button type="submit"
                ...
                <i class="fas fa-sign-in-alt text-[0.85rem]"></i> Masuk
            </button>
        </form>
