...
<div class="px-4 md:px-10 lg:px-[80px] py-10 lg:py-[60px] min-h-[70vh]">
    ...
    <div class="space-y-4" id="orderList">
        ...
        <div class="order-card bg-white rounded-[16px] border border-maroon-200 overflow-hidden shadow-sm transition-all duration-200 hover:shadow-[0_6px_24px_rgba(139,26,26,0.08)] {{ $defaultTab !== $group ? 'hidden' : '' }}"
             data-group="{{ $group }}">
