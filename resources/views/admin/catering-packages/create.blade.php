...
<div class="mb-8">
    ...
    <h2 class="font-playfair text-3xl font-bold text-gray-800 mt-3">Tambah Paket Catering</h2>
</div>

<form method="POST" action="{{ route('admin.catering-packages.store') }}" enctype="multipart/form-data">
@csrf
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="contoh: Paket Nasi Box Komplit"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" placeholder="Isi paket, menu, dll..."
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6">
            <h3 class="font-semibold text-gray-800 mb-5 pb-3 border-b border-gray-100">Foto Paket <span class="text-red-500">*</span></h3>
