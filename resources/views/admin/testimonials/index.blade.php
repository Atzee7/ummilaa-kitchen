...
<div class="px-6 py-8 max-w-7xl mx-auto">
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-800" style="font-family:'Playfair Display',serif;">Kelola Testimoni</h1>
        <p class="text-sm text-gray-500 mt-1">Semua ulasan pelanggan ditampilkan otomatis. Hapus jika ada konten yang tidak pantas.</p>
    </div>

    @if(session('success'))
        <div class="mb-6 flex items-center gap-3 p-4 rounded-xl text-sm font-semibold"
    ...
    <div class="grid grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            <p class="text-xs font-semibold uppercase tracking-wider mb-1" style="color:#d97706;">Rata-rata Rating</p>
            <p class="text-3xl font-bold" style="color:#d97706;">
                {{ $testimonials->count() ? number_format($testimonials->avg('rating'), 1) : '-' }}
                <span class="text-base">★</span>
            </p>
        </div>
        <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            <p class="text-xs font-semibold uppercase tracking-wider mb-1" style="color:#16a34a;">Bintang 5</p>
            <p class="text-3xl font-bold" style="color:#16a34a;">{{ $testimonials->where('rating', 5)->count() }}</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        @else
            <table class="w-full">
                <thead>
                    <tr style="background:#fafafa; border-bottom:1.5px solid #f0e8e8;">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <span class="text-sm font-bold px-3 py-1 rounded-lg"
                                  style="background:#fdf5f5; color:#8B1A1A;">
