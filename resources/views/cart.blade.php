...
<div class="px-[80px] py-[60px]">
    ...
    @else
    <div class="grid grid-cols-[1fr_360px] gap-10 items-start">
        ...
        <div class="bg-white border-[1.5px] border-maroon-200 rounded-[20px] p-7 shadow-[0_4px_24px_rgba(139,26,26,0.05)] sticky top-[90px]">
            ...
            <div class="flex justify-between items-center mb-[14px] text-[0.9rem]">
                <span class="text-[#777]">Ongkir (estimasi)</span>
                <strong class="text-[#1a1a1a] font-bold">Rp15.000</strong>
            </div>
            <div class="h-px bg-maroon-200 my-4"></div>
            <div class="flex justify-between items-center mb-6">
                <span class="font-extrabold text-[#1a1a1a] text-base">Total</span>
                <strong class="font-extrabold text-maroon text-[1.2rem]">Rp{{ number_format($subtotal + 15000, 0, ',', '.') }}</strong>
            </div>
