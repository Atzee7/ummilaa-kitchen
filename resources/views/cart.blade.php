...
<div class="px-4 md:px-10 lg:px-[80px] py-8 lg:py-[60px]">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 lg:gap-10 items-start">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div data-cart-row="{{ $cart->id }}" class="grid grid-cols-[90px_1fr_auto] gap-5 items-center bg-white border-[1.5px] border-maroon-200 rounded-[18px] p-5 transition-shadow hover:shadow-[0_6px_24px_rgba(139,26,26,0.07)]">
